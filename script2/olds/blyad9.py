...
# sağ sol kenar merkezler
cv2.circle(image, left_edge_center , 5, (255, 0, 255), -1)
cv2.circle(image, right_edge_center , 5, (255, 0, 255), -1)


# Draw lines between the centers and edge centers for left and right hulls
cv2.line(image, left_center, left_edge_center, (255, 0, 0), 2)
cv2.line(image, right_center, right_edge_center, (255, 0, 0), 2)

# Draw dots for the centers of the left and right hulls
cv2.circle(image, left_center, 5, (255, 0, 255), -1)
cv2.circle(image, right_center, 5, (255, 0, 255), -1)
