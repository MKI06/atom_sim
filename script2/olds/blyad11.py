...
left_extended_start = (left_center[0] - 2 * left_direction[0], left_center[1] - 2 * left_direction[1])
left_extended_end = (left_center[0] + 2 * left_direction[0], left_center[1] + 2 * left_direction[1])
...
right_extended_start = (right_center[0] - 2 * right_direction[0], right_center[1] - 2 * right_direction[1])
right_extended_end = (right_center[0] + 2 * right_direction[0], right_center[1] + 2 * right_direction[1])
